...
{
    /// <summary>
    /// Collection of <see cref="byte"/> extension methods.
    /// </summary>
    public static class ByteExtensions
    {
        ...
        public static string ToHexString(this byte[] value)
        {
            return value == null 
                ? string.Empty 
                : value.Aggregate(new StringBuilder(), (builder, b) => builder.Append(HexStringTable[b])).ToString();

            //            var builder = new StringBuilder();
//            foreach (var b in value) builder.Append(HexStringTable[b]);
